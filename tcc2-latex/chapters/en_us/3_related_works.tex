...
(2023), it leads both of them~\cite{pereira2023mulletbench,wang2023iotdb}, suggesting
either significant performance improvements in recent versions or a growing recognition of
its strengths for IoT-oriented workloads.
...
NYC Taxi data, IoT sensor readings, and industrial vehicle data~\cite{shah2022performance,
...
case~\cite{wang2023iotdb}), and storage from SATA SSD to NVMe and HDD. The majority of
tests used mid-range machines, consistent with a focus on realistic deployment scenarios.
The inclusion of cloud testing in more recent studies~\cite{pereira2023mulletbench,wang2023iotdb}
