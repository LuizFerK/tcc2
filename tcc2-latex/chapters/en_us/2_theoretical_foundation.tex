...
\textbf{TimescaleDB} extends PostgreSQL with time-series optimizations~\citep{Ramakrishnan2003}.
...
Among the five performance studies reviewed in this work, only one provides the scripts
