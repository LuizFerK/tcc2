...
gerado a cada segundo. Essa explosão de dados sequenciais com carimbo de tempo expôs as
...
temporais~\cite{InfluxDataTimeSeries}. Como argumentado por~\cite{naqvi2017influxdb}, os
...
escalabilidade e uso econômico de recursos~\cite{Dunning2014}.

O cenário dos BDSTs diversificou-se consideravelmente nos últimos anos, com sistemas
adotando abordagens arquiteturais radicalmente distintas para o mesmo problema.
...
extremamente elevadas. O \textit{InfluxDB} é o BDST mais amplamente avaliado em benchmarks
na literatura recente~\cite{naqvi2017influxdb,shah2022performance,lima2024avaliando},
usando um motor de armazenamento Time-Structured Merge Tree (TSM) exposto via API HTTP com
protocolo de linha. O \textit{TimescaleDB} estende o PostgreSQL com capacidades de séries
temporais~\cite{Ramakrishnan2003}, oferecendo compatibilidade com SQL e o ecossistema
...
suficientes para permitir replicação independente~\cite{pereira2023mulletbench,shah2022performance,naqvi2017influxdb}.
...
contêineres, ambiente de construção e clientes Java de benchmark parametrizados)
...
estabelecido, Apache IoTDB como o líder emergente nos dois estudos mais recentes~\cite{pereira2023mulletbench,wang2023iotdb},
...
\begin{itemize}
  ...
  \item Analisar como as características de desempenho escalonam com o volume de dados
    em três escalas abrangendo 100$\times$ no tamanho dos dados;
...
A Seção~\ref{sec:theoretical} apresenta os fundamentos teóricos cobrindo bancos de dados,
