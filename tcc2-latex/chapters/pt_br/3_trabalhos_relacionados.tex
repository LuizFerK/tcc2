...
registros) e consultas de agregação com dados sintéticos (medições de carimbo de tempo,
...
nos dois estudos mais recentes (2023), ele lidera em ambos~\cite{pereira2023mulletbench,wang2023iotdb},
sugerindo melhorias significativas de desempenho nas versões recentes ou um crescente
reconhecimento de seus pontos fortes para cargas de trabalho orientadas a IoT.
...
dados industriais de veículos~\cite{shah2022performance,naqvi2017influxdb,wang2023iotdb},
...
em um caso~\cite{wang2023iotdb}), e o armazenamento de SATA SSD a NVMe e HDD. A maioria dos
testes utilizou máquinas de médio porte, consistente com foco em cenários de implantação
realistas. A inclusão de testes em nuvem em estudos mais recentes~\cite{pereira2023mulletbench,wang2023iotdb}
