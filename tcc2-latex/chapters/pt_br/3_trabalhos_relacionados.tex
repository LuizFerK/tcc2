...
TimescaleDB em quatro dos seis estudos reflete sua crescente relevância como alternativa
...
revisada. Dos seis estudos de desempenho, apenas um (\cite{pereira2023mulletbench})
...
\textbf{Conjuntos de dados.} Todos os seis estudos utilizam conjuntos de dados sintéticos,
...
\textbf{Tendências de resultados.} O InfluxDB lidera em três dos seis estudos (2017, 2022
e 2024). O Apache IoTDB lidera em ambos os estudos de 2023. O PostgreSQL lidera no estudo
de computação de borda~\citep{grzesik2020comparative}, resultado atribuível ao hardware
restrito do Raspberry~Pi em vez de características gerais de desempenho de BDSTs. O padrão
temporal entre os benchmarks de propósito geral permanece notável: pode indicar melhorias de
desempenho nas versões recentes do IoTDB, ou pode refletir o fato de que benchmarks mais
recentes incluem cargas de trabalho específicas de IoT nas quais o modelo de dados nativo do
IoTDB oferece uma vantagem estrutural. A mudança não invalida necessariamente o InfluxDB para
outras cargas de trabalho; no entanto, motiva a inclusão de ambos os bancos de dados em
qualquer avaliação comparativa contemporânea.
