...
construída sobre Docker Compose, Nix e iot-benchmark~\cite{iotbenchmark}.
...
abaixo de 1\,ms em todo o crescimento de 100$\times$ nos dados, tornando-o a escolha mais
...
(crescimento de latência de 5,2$\times$ para dados 100$\times$ maiores) porque suas
...
completo. Esses comportamentos são invariantes arquiteturais que sobrevivem a mudanças de
hardware, configuração ou versão do banco de dados.
